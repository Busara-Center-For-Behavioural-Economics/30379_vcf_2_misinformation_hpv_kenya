...
baseline_data[baseline_data$final_ID %in% c("98197Dec9171002", "76186Dec9123254", "77103Dec9105523", "84166Dec9134533", "13193Dec9154005", "44173Dec9144909", "20185Dec8174959", "77181Dec8164121", "38171Dec8154903", "42152Dec8133125", "44147Dec8114606", "39177Dec9113313"), ]$B0_cluster <- 428

baseline_data[baseline_data$final_ID %in% c("29187Nov29101906"), ]$B0_cluster  <- 128

baseline_data[baseline_data$final_ID %in% c("63200Oct30121711", "29166Nov3090457", "69154Oct30154755"), ]$B0_cluster <- 230

baseline_data[baseline_data$final_ID %in% c("66183Nov8160224"), ]$B0_cluster <-280

baseline_data[baseline_data$final_ID %in% c("63130Nov24165008"), ]$B0_cluster <- 364

baseline_data[baseline_data$final_ID %in% c("77166Dec7104701"), ]$B0_cluster <- 103

baseline_data[baseline_data$final_ID %in% c("102177Oct28132949", "70115Oct28164915"), ]$B0_cluster <- 318

baseline_data[baseline_data$final_ID %in% c("74106Dec13163729"), ]$B0_cluster <- 318

baseline_data[baseline_data$final_ID %in% c("20162Oct24145318"), ]$B0_cluster <- 207

baseline_data[baseline_data$final_ID %in% c("84165Nov23100932"), ]$B0_cluster <- 403

baseline_data[baseline_data$final_ID %in% c("72127Oct26150254", "89150Oct26160443"), ]$B0_cluster <- 215

baseline_data[baseline_data$final_ID %in% c("81161Nov16102342", "52162Nov16113233", "22111Nov16130039", "59133Nov16141055"), ]$B0_cluster <- 239

baseline_data[baseline_data$final_ID %in% c("28141Nov16130304", "104102Nov18143305", "63125Nov18155500", "35187Nov18165511", "27131Nov16101344", "15134Nov16170730"), ]$B0_cluster <- 218

baseline_data[baseline_data$final_ID %in% c("61139Nov23144905"), ]$B0_cluster <- 282

baseline_data[baseline_data$final_ID %in% c("67105Dec15104756"), ]$B0_cluster <- 97

baseline_data[baseline_data$final_ID %in% c("64199Nov1141133"), ]$B0_cluster <- 97
