...
TukeyHSD(aov(manipulativeness_assessment_score ~ cluster_treatment_group, data = manipulativeness_df))
...
# Single Effects
TukeyHSD(aov(detect_misinfo_1_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_2_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_3_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_4_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_5_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_6_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_7_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_8_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_9_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_10_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_11_1 ~ cluster_treatment_group, data = manipulativeness_df))
TukeyHSD(aov(detect_misinfo_12_1 ~ cluster_treatment_group, data = manipulativeness_df))
...
truth_discernment <- endline_data[,c("id", "cluster_treatment_group", paste0("truth_discernment_", 1:16))] %>% 
  replace_with_na_all(condition = ~.x %in% c(88, 99))
...
truth_discernment %>% 
  group_by(cluster_treatment_group) %>% 
  summarise(extremes_count_mean = mean(extremes_count, na.rm = T))
...
vax_comm_exp <- endline_data[,c("id", "cluster_treatment_group", paste0("vax_hes_1"))]
...
vax_attitudes <- endline_data[,c("id", "cluster_treatment_group", paste0("vax_hes_", 2:9))]
...
temp1 <- merge(temp, truth_discernment[, c("id", "auc", "auc_hpv_only", "auc_non_hpv", "extremes_count")], by = "id")
...
TukeyHSD(aov(vax_beh_int_2 ~ cluster_treatment_group, data = vax_beh_int))
TukeyHSD(aov(vax_beh_int_3 ~ cluster_treatment_group, data = vax_beh_int))
TukeyHSD(aov(vax_beh_int_4 ~ cluster_treatment_group, data = vax_beh_int))
...
TukeyHSD(aov(vax_beh_int_6 ~ mini_treatment, data = mini_treatment))
mini_treatment %>% 
