...
# Create temp df
temp_df <- combined %>% 
  select(introduction.1.player.assigned_group, survey.1.player.vax_hes_1, survey.1.player.vax_hes_2)
...
# Create temp df
temp_df <- combined %>% 
  select(introduction.1.player.assigned_group, paste0("survey.1.player.vax_hes_",3:12))
...
# Create temp df
temp_df <- combined %>% 
  select(introduction.1.player.assigned_group, paste0("survey.1.player.vax_beh_int_",1:5))
