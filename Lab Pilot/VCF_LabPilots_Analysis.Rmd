...
participant_row <- temp_df[1,paste0("survey.1.player.detect_misinfo_quiz", 1:16, "_2")]
post_number <- 1
technique <- "Impersonating people through fake accounts"
...
# 4. Repeat all analyses by Gender & Religion
